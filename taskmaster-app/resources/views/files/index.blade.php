...
@section('content')
    <a class="btn btn-primary btn-xl" href="{{ route('files.create') }}"><i class="fa-solid fa-plus"></i> Adicionar projeto</a><br><br>
    @if ($files->count() > 0)
        <div class="row">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('files.edit', $item->id) }}" class="btn btn-warning"> <i
                                    class="fa-solid fa-pen-clip"></i> Editar Arquivo</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="label-file-{{ $item->id }}">Excluir Arquivo</h5>
